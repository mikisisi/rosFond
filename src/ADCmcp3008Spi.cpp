...
int ADCmcp3008Spi::spiOpen(std::string devspi)
{
    int statusVal = -1;
...
int ADCmcp3008Spi::spiWriteRead( unsigned char *data, int length)
{
 ...
 * ***********************************************/
ADCmcp3008Spi::ADCmcp3008Spi(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord)
{
    this->mode = spiMode ;
